...
def test_logging():
    ...
    log(clear=True, verbosity=1)
    qp.qlang_v3.VERBOSITY = 0
    result = df.q(r'$verbosity=0')
    qp.qlang_v3.VERBOSITY = 3
...
def test_symbols():
    sym1 = qp.qlang_v3.OPERATORS['=']
    sym1a = qp.qlang_v3.OPERATORS.SET
    sym1b = qp.qlang_v3.OPERATORS['SET']
    sym2 = qp.qlang_v3.OPERATORS.TRIM
    ...
    symbols_modify1 = qp.qlang_v3.OPERATORS.modify
    symbols_modify2 = qp.qlang_v3.OPERATORS['modify']
    ...
    assert qp.qlang_v3.OPERATORS['x'] is None, f'should return None for unknown symbol'
    check_message('ERROR: symbol "x" not found in "OPERATORS"')

    connectors = qp.qlang_v3.CONNECTORS.__str__()
    expected = 'CONNECTORS:\n\t<"%%%": NEW_SELECT_VALS>\n\t<"&&&": AND_SELECT_VALS>\n\t<"///": OR_SELECT_VALS>\n\t<"%%": NEW_SELECT_ROWS>\n\t<"&&": AND_SELECT_ROWS>\n\t<"//": OR_SELECT_ROWS>\n\t<"%": NEW_SELECT_COLS>\n\t<"&": AND_SELECT_COLS>\n\t<"/": OR_SELECT_COLS>\n\t<"$": MODIFY>'
